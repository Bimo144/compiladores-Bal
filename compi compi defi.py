...
def ventana_principal():
    ...
    tk.Label(ventana, text="Escriba el código a analizar:", font=("Arial", 12)).pack(pady=5)
    text_area = scrolledtext.ScrolledText(ventana, width=80, height=25, font=("Courier", 10))
    text_area.pack(padx=10, pady=10)
    tk.Button(ventana, text="Continuar", command=guardar_codigo, width=30, height=2, bg="#4CAF50", fg="white").pack(pady=10)
    ventana.mainloop()
